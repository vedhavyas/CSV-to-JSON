...
def qsqldb( sqldb, sql_cmd, chart_no, chart_x_axis, chart_y_axis, chart_legend, chart_color, chart_count):
	...
	for i in range (num_col):
	  temp['column_'+str(i)]=0
        ...
        temp_arr["graphdata"]=data
        return temp_arr


def qcsv(infilenames,file_db, keep_db, sql_cmd, chart_no, chart_x_axis, chart_y_axis, chart_legendlist, chart_color, chart_count):
	...
	#
	# Execute the SQL
	val=qsqldb( conn, sql_cmd, chart_no, chart_x_axis, chart_y_axis, chart_legendlist, chart_color, chart_count)
	#
	# Clean up.
	conn.close()
...
if __name__=='__main__':
        ...
        for i in range (1,chart_count+1): 
           ...
           while (count < table_no):
              ...
              count = count + 1
           temp_data=qcsv(table_names, file_db, keep_db, query_string, i, chart_x_axis, chart_y_axis, chart_legendlist, chart_color, chart_count)
           print ("chart :" + str(i))
